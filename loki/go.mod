module github.com/fluxplane/fluxplane-plugins/loki

go 1.26.1

require github.com/fluxplane/fluxplane-datasource v0.2.0
...
require (
	...
	github.com/fluxplane/fluxplane-plugin v0.13.1
