module github.com/fluxplane/fluxplane-plugins/duckduckgo

go 1.26.1

require github.com/fluxplane/fluxplane-plugins/websearch v0.0.0
...
replace github.com/fluxplane/fluxplane-plugins/websearch v0.0.0 => ../websearch
