module github.com/fluxplane/fluxplane-plugins/openai

go 1.26.1

require github.com/fluxplane/fluxplane-plugins/vision v0.0.0
...
replace github.com/fluxplane/fluxplane-plugins/vision v0.0.0 => ../vision
