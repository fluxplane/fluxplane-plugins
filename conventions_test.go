...
func TestProbeOperationNaming(t *testing.T) {
	allowed := map[string]bool{
		`atlassian/confluence: "confluence.auth.test"`: true,
		`atlassian/jira: "jira.auth.test"`:             true,
...
func seededOmitemptyAllowlist() map[string]bool {
	return map[string]bool{
		...
		"atlassian/jira: IssueTransitionRunResult.AppliedTransitions":   true,
		"atlassian/jira: IssueTransitionRunResult.AvailableTransitions": true,
